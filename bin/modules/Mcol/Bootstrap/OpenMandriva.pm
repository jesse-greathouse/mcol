#!/usr/bin/env perl
package Mcol::Bootstrap::OpenMandriva;
...
my @pkgs = qw(
  gcc make pkgconfig libopenssl-devel perl-App-cpanminus curl tar unzip
);

sub install_bootstrap_toolchain {
    print "Installing minimal build toolchain for OpenMandriva...\n";
