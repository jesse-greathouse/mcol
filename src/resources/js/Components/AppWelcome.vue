...
<template>
  <div>
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
      ...
      <h1 class="mt-8 text-2xl font-medium text-gray-900">Let's get a downloadin'!</h1>

      <p class="mt-6 text-gray-500 leading-relaxed">
        Mcol brings you the latest media available for download. High quality search and browsing
        functionality. All downloads are Peer to Peer and 100% private.
        <i>These are not torrents</i>. VPN or IP masking of any kind is not necessary. Your privacy
        matters. Download anonously and safely with Mcol.
      </p>
    </div>
