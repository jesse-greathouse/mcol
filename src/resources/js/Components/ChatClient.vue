            ...
            <div class="flex w-full flex-col border-white border-opacity-10">
                <ul class="flex flex-col items-center justify-start gap-1 w-full" ref="channelTabs" id="channel-tabs" role="tablist">
                    ...
                    <li v-for="nick in privmsgTabs" :ref="`${nick}-tab`" role="presentation" class="w-full block">
                        <button type="button" :ref="`${nick}-trigger`" role="tab" :aria-controls="`${nick}-tab`" aria-selected="false" class="block px-3 w-full text-left rounded-md border border-gray-400 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" >
                            {{ nick }}
                        </button>
                    </li>
                </ul>
