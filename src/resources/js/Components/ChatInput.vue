<template>
    <div class="relative flex flex-row width-full pr-4 py-2">
        <chat-command class="!relative left-5 top-4 z-10"
            :target="targetId"
            :selected="command"
        ...
        <chat-parameter v-for="(parameter, index) in parameters" :key="index" class="multiselect-gray"
            :parameter="parameter"
            :optionList="parameterLists[index]"
        ...
        <input type="text" class="block w-full p-4 pl-32 font-mono text-base text-gray-900 border border-gray-300 rounded bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ref="command"
