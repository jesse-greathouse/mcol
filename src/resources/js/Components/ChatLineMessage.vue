<template>
    <div class="flex items-start w-full mr-4">
        ...
        <div class="inline-flex items-start">
            <component v-bind:is="contentComponent" :settings="settings" :content="content" :packet="packet"
                :download="download" :isDownloadLocked="isDownloadLocked" @call:xdccSend="xdccSend"
