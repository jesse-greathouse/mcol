        ...
        <div
            ...
            <div class="flex items-start my-2.5 bg-gray-50 dark:bg-gray-600 rounded-xl p-2">
                <div class="me-2 width-full">
                    <download-queue-completed v-if="isCompleted" :download="download" :settings="settings"
                        @call:removeCompleted="removeCompleted"
                        @call:saveDownloadDestination="saveDownloadDestination" />
                    <download-queue-downloading v-if="isDownloading" :download="download" :settings="settings"
                        @call:requestCancel="requestCancel" @call:saveDownloadDestination="saveDownloadDestination" />
                    <download-queue-queued v-if="isQueued" :download="download" :settings="settings"
