<template>
    <div class="flex font-mono text-base max-w-full mb-1">
        ...
        <line-message v-if="line.type === 'message'" :settings="settings" :downloads="downloads"
            :downloadLocks="downloadLocks" :message="message" :channel="channel" @call:xdccSend="xdccSend"
