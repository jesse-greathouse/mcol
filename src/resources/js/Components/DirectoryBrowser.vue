<template>
            ...
            <div class="w-full grid gap-3 grid-cols-12 grid-rows-3">
                <div class="col-span-3">
                    <multiselect tabindex="-1" class="hover:text-gray-700 focus:text-indigo-500 text-sm"
                        v-model="selectedStore" :options="mediaStoreOptions" :canClear="false" ref="mediaStores" />
                </div>
                <div class="col-span-8">
                    <multiselect tabindex="-1" class="hover:text-gray-700 focus:text-indigo-500 text-sm"
                        v-model="selectedRoot" :options="storeRootsOptions" :canClear="false" ref="storeRoots" />
                </div>
                ...
                <div class="col-span-12">
                    <input type="text" class="min-w-60 relative px-6 py-3 w-full rounded focus:shadow-outline"
                        :disabled="true" v-model="displayUri" ref="displayUri" />
                </div>
                <div class="col-span-12">
                    <div class="inline-flex">
                        <button ref="up" type="button"
                            ...
                            :disabled="(displayUri === selectedRoot)" @click="openDir(parent)">
                            <up-directory-icon />
                            <span class="sr-only">Up to {{ parent }}</span>
                        </button>
                        <button ref="new" type="button"
                            class="text-white disabled:opacity-75 disabled:bg-gray-100 focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-0 dark:bg-gray-800 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700"
    ...
    <div data-popover
        ...
        ref="createDirPop" :id="createDirPopId" role="tooltip">
        <div class="p-3">
            ...
            <div class="flex flex-row p-3">
                <div class="basis-1/3 px-3">
                    <input type="text" class="min-w-60 relative px-6 py-3 w-full rounded focus:shadow-outline"
                        v-model="displayUri" :disabled="true" />
                </div>
                <div class="basis-2/3">
                    <input type="text" class="min-w-60 relative px-6 py-3 w-full rounded focus:shadow-outline"
                        v-model="createDirName" ref="createDirName" />
                </div>
            </div>
