<template>
  ...
  >
    <svg
      class="stroke-white fill-none stroke-2 w-6 h-6"
      aria-hidden="true"
      viewBox="0 0 24 24"
      version="1.1"
    ...
    <div class="p-3">
      ...
      <div class="flex flex-row p-3">
        <div class="basis-1/3 px-3">
          <multiselect
            tabindex="-1"
            class="min-w-48 p-1 hover:text-gray-700 focus:text-indigo-500 text-sm"
...
export default {
  ...
  mounted() {
    ...
    this.destinationPop = new Popover(
      this.$refs.destinationPop,
      this.$refs.saveFile,
      { placement: 'left' },
      {
